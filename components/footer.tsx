...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary text-secondary-foreground">
      <div className="bg-gradient-to-r from-primary/20 to-primary/10 border-y border-secondary-foreground/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            {/* Quick Contact - 3 Boxes on One Line */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <a href="tel:+201012595634" className="flex flex-col items-center justify-center text-center gap-2 p-4 bg-secondary-foreground/10 rounded-lg hover:bg-secondary-foreground/20 transition-all group">
              ...
              <a href="mailto:montaser.mohamed@elfedawia.com" className="flex flex-col items-center justify-center text-center gap-2 p-4 bg-secondary-foreground/10 rounded-lg hover:bg-secondary-foreground/20 transition-all group">
              ...
              <a href="#" className="flex flex-col items-center justify-center text-center gap-2 p-4 bg-secondary-foreground/10 rounded-lg hover:bg-secondary-foreground/20 transition-all group">
      ...
      {/* Main Footer Footer Content... (remainder of your file) */}
    </footer>
  )
}