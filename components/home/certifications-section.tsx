...
export default function CertificationsSection() {
  ...
  const certifications = [
    ...
    },
    {
      id: "fda",
      name: "FDA Compliant",
      category: "Food & Cosmetics Grade",
      icon: CheckCircle,
      description: "Approved for use in food, cosmetic, and pharmaceutical applications",
      details: [
        "Meets FDA Title 21 CFR Part 182 requirements",
        "Suitable for food additives and supplements",
    ...
    },
    {
      ...
      icon: Zap,
      description: "Certified halal for Islamic compliance and market access",
      details: [
        "Complies with halal production standards",
        "No prohibited substances or additives",
        "Segregated production facilities",
        "Recognized by halal certification bodies",
        "Growing market access in Islamic regions",
      ],
