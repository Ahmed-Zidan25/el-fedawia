  ...
  'agricultural-gypsum': {
    ...
    benefits: [
      ...
      },
      {
        ...
        subItems: ['Protein synthesis', 'Enzyme activation', 'Improved crop quality', 'Better tolerance to stress conditions'],
      },
      {
...
export default function ProductDetailPage({ params }: { params: { slug: string } }) {
  // NOTE: This is a Client Component. Do NOT use React experimental `use()` here.
  const slug = decodeURIComponent(params.slug)
  const product = productDetails[slug as keyof typeof productDetails]

  // Avoid hydration mismatch from animations / theme-dependent UI
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-50 dark:bg-slate-950">
        <h1 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Product Not Found</h1>
        <Link href="/products" className="text-red-600 flex items-center gap-2 font-semibold">
  ...
  // Applications can be: string[] OR {title,image}[] (we support both)
  const applications = useMemo(() => {
    const raw = (product as any)?.applications
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: (product as any).longContent || '' }}
            />
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-col gap-4">
              {(product as any).benefits?.map((benefit: any, i: number) => (
