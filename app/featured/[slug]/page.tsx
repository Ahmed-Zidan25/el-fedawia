...
const productDetails = {
  ...
  'talc-powder': {
    ...
    applications: [
      ...
      { title: 'Home Pesticides', image: '/applications/talc-petisides.png' },
    ...
    benefits: [
      {
        title: 'Paints',
        text: 'Talc powder is considered one of the essential filler materials in the paint and coatings industry, playing a key role in enhancing the technical performance of the final product while also reducing overall production costs.',
      },
      {
        title: 'Agricultural Pesticides',
        text: 'Talc is an important material used in the manufacturing of agricultural pesticides, where it serves as a carrier and diluent for active ingredients in various formulations.',
      },
      {
        title: 'Household Insecticide',
        text: 'Talc is used in the production of certain types of household insecticides, particularly in powder formulations and dry baits, where it functions as a carrier and diluent for active ingredients.',
      },
      {
        title: 'Bar Soap',
        text: 'Ground talc is used in certain types of bar soap due to its fine texture and chemical stability. It is added in controlled amounts to improve the consistency of the soap bar and increase its hardness.',
      },
    ],
  ...
  // ✅ FIXED: key quoted + structure corrected
  'agricultural-gypsum': {
    ...
    applications: [{ title: 'Fertilizers', image: '/featured-gypsum.jpg' }],
    benefits: [
      {
      ...
      },
      {
        ...
        subItems: ['Stronger root systems', 'Higher yield', 'Better crop quality'],
      },
      {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-20 px-4 md:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {/* ✅ HERO: single column, no top buttons, no right box */}
